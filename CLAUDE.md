...
Behavioral guidelines to reduce agentic coding failures caused by missing context. Merge with project-specific instructions as needed.
...
**These guidelines are working if:** unknowns are surfaced before implementation, plans lead with decisions that matter, deviations are captured while coding, and reviewers understand the change without guessing.
